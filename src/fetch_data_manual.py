...
ENDPOINTS = {
    ...
    #     # {'metric': 'transfers_volume_between_exchanges_sum_pit', 'params': ['c', 'from_exchange', 'to_exchange']},
    #     # {'metric': 'transfers_between_exchanges_count_pit', 'params': ['from_exchange', 'to_exchange']},
